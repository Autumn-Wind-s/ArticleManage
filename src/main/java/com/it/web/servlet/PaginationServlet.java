...
public class PaginationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       request.setCharacterEncoding("utf-8");
        ...
        switch (Type){
            case "1": pageType="议论文"; break;
            case "2": pageType="散文"; break;
            case "3": pageType="说明文"; break;
            case "4": pageType="记叙文"; break;
            case "5": pageType="小说"; break;
            case "6": pageType="诗歌"; break;
            case "7": pageType="应用文"; break;
        }
        int currentPage = 0;
        int pageSize = 0;
        ...
        PageBean<Article> articlePageBean = articleService.pageQuery(currentPage, pageSize,pageType);
