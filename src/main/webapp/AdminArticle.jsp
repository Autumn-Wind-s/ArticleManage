...
<head>
    ...
    <script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for (var i = 1; i <= data.totalPage; i++) {
                        ...
                        }else {var li = '<li><a href = "javascript:up('+pageType+','+i+',5)">' + i + '</a></li>'
                        }
                        list += li;
                    }
        ...
        $(function ()
            {if ("${sessionScope.articleSelect}"==0){
                up("${sessionScope.articleType}", "${sessionScope.articleCurrent}", 5)
            }else {
                select("${sessionScope.articleType}","${sessionScope.articleCurrent}", 5)
            }
                $("#se").click(
                    function ()
                    {
